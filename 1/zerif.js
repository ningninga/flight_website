...
$.vegas('slideshow', {
  delay:7000,
  backgrounds:[
    { src:'/Public/image/bg1.jpg', fade:1000 },
    { src:'/Public/image/bg2.jpg', fade:1000 },
    { src:'/Public/image/bg3.jpg', fade:1000 },
    { src:'/Public/image/bg5.jpg', fade:1000 },
    { src:'/Public/image/bg6.jpg', fade:1000 }
  ]
});
...
$(document).ready(function() {
  ...
  // Sticky Header - /jqueryfordesigners.com/fixed-floating-elements/
